...
interface ContextConsolidationFormProps {
  productId: string
...
export default function ContextConsolidationForm({ 
  productId, 
  conversationId, 
  onConfirm, 
  onCancel 
}: ContextConsolidationFormProps) {
  ...
  useEffect(() => {
    // Buscar texto consolidado ao montar o componente
    async function fetchConsolidatedText() {
      try {
        ...
        setChangeReason('Consolidação inicial do Contexto Cognitivo do Produto')
      } catch (err) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{
          ...
          Consolidar Contexto Cognitivo do Produto
        </h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <input
                ...
                required
                placeholder="Ex: Consolidação inicial do Contexto Cognitivo do Produto"
                style={{
                  width: '100%',
                  padding: '0.75rem 1rem',
                  border: '1px solid #e5e5e5',
